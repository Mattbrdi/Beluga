...
sans bruit mais est bien trop approximatif avec bruit, comme on peut le voir 
figure~\ref{fig:energy-bin-noise}. Cela motive donc l'utilisation 
d'un réseau de neuronne pour cette tache qui s'apprend bien mais reste loin d'être triviale
...
\begin{figure}[htbp]\label{fig:cluster-pts14}
  ...
  \end{minipage}
  \caption{Extrait 14 : clusters avant et apres attribution.}
...
\begin{figure}[htbp]\label{fig:RANSAC-pts14}
  ...
  \end{minipage}
  \caption{Extrait 14 : comparaison entre la reference et la droite estimee par RANSAC.}
