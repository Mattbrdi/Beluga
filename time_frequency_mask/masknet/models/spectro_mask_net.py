...
# B, 4, 256, 256 
        ...
        self.down2 = (Down(128, 256)) # B, 256, 32, 32
        self.down3 = (Down(256, 512)) # B, 512, 16, 16
        factor = 2 if bilinear else 1
        self.down4 = (Down(512, 1024 // factor)) # B, 1024, 8, 8 
        self.up1 = (Up(1024, 512 // factor, bilinear)) # B, 512, 64, 64
